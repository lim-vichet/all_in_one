              ...
              return BlocConsumer<UploadBloc, UploadState>(
                listener: (uploadContext, state) {
                  if ( state is UploadSuccessState ) {
                    ...
                    log("Upload Success =========${jsonEncode(listResultFile)}");
                    ...
                    print("listResultFilww===========${jsonEncode(listResultFile)}");
                  }
...
//                                           // BlocProvider.of<UploadBloc>(uploadContext).add(OnEventXFile(listImage));
//
//                                           print("approveByName==========${approveByName}");
//                                           print("purposeController.text==========${purposeController.text}");
//                                           print("fromDateController.text==========${fromDateController.text}");
//                                           print("fromTimeController.text==========${fromTimeController.text}");
//                                           print("toDateController.text==========${toDateController.text}");
//                                           print("toTimeController.text==========${toTimeController.text}");
