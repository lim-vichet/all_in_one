...
//                                     child: AutoSizeText(
//                                       "Upload Your Files".tr,
//                                       style: AppTextStyleV2().textTitleSizeXS(color: AppColors().grey),
//                                     ),
//                                   ),
//                                 ],
//                               )),
...
//                     alignment: Alignment.centerLeft,
//                     width: double.infinity,
//                     margin: EdgeInsets.only(top: listImage.isEmpty ? 0 : 10),
//                     height: listImage.isEmpty ? 10 : 90,
//                     child: ListView.builder(
//                         itemCount: listImage.length,
//                         scrollDirection: Axis.horizontal,
//                         physics: const BouncingScrollPhysics(),
...
//             content: Container(
//               padding: EdgeInsets.symmetric(vertical: AppDimension().medium),
//               // height: ScreenUtil().screenWidth >= 500 ? screenWidth * 0.20 : screenWidth * 0.40,
//               // width: screenWidth / 4.5,
//
//               height: 200,
//               width: 100,
...
//                               child: Text(
//                                 'Pick With Photo'.tr,
//                                 style: AppTextStyleV2().textTitleSizeS(),
//                               ),
//                             )
//                           ],
//                         ),
