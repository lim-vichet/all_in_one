...
class DropDownTextField extends StatefulWidget {
  ...
  const DropDownTextField({
    ...
    this.maxLines,
    this.minLines,
    this.isSearchVisible = true, required String isError,
  }) : super(key: key);
...
class _DropDownTextFieldState extends State<DropDownTextField> {
  ...
  String tmpImplode(Map<dynamic, dynamic> options, List<dynamic> tmpSelectedList) {
    Map<dynamic, dynamic> tmpOptions = Map<dynamic, dynamic>.from(options);
