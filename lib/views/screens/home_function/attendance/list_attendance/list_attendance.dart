...
class _ListAttendanceScreenState extends State<ListAttendanceScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ListAttendanceBloc()
        ..add(GetListAttendanceUserEvent(
            ...
            SizedBox(
                ...
                child: Container(
                  ...
                  child: SingleChildScrollView(
                    child: BlocConsumer<ListAttendanceBloc, ListAttendanceState>(
                                          ...
                                          child: Container(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                resultListAttendance[index].date == null || resultListAttendance[index].date ==""?
                                                Text("N/A",
                                                  style: TextStyle(
                                                    color: AppColors().white,),):
                                                Text("${resultListAttendance[index].date}",
                                                              ...
                                                              child: Row(
                                                                children: [
                                                                  ...
                                                                  Expanded(
                                                                      flex: 2,
                                                                      child:
                                                                      resultListAttendance[index].morningCheckInTime == null || resultListAttendance[index].morningCheckInTime == ''?
                                                              ...
                                                              child: Row(
                                                                children: [
                                                                  ...
                                                                  Expanded(
                                                                      flex: 2,
                                                                      child:
                                                                      resultListAttendance[index].morningCheckOutTime.isNotEmpty ?
                                                                      Text(resultListAttendance[index].morningCheckOutTime , style: AppTextStyle().textS()):
                                                              ...
                                                              child: Row(
                                                                children: [
                                                                  ...
                                                                  Expanded(
                                                                      flex: 2,
                                                                      child:
                                                                      resultListAttendance[index].afternoonCheckInTime == null ||resultListAttendance[index].afternoonCheckInTime.isEmpty ?
                                                                      Text("Absent".tr, style: AppTextStyle().textS(color: AppColors().primaryRed)):
                                                              ...
                                                              child: Row(
                                                                children: [
                                                                  ...
                                                                  Expanded(
                                                                      flex: 2,
                                                                      child:
                                                                      resultListAttendance[index].afternoonCheckOutTime == null?
                                                                      Text("N/A".tr, style: AppTextStyle().textS(color: AppColors().primaryRed)):
                        ...
                        Row(
                          children: [
                            InkWell(
                              onTap: () async {
                                fromDate =
                                    await AppDatePickers().datePickers(context);
                                setState(() {
                            ...
                            InkWell(
                              onTap: () async {
                                ...
                                if (fromDate.compareTo(toDate) == 0) {
                                  ...
                                  // print("Hello kon papa 3");
                                  // showDialog(context: context, builder: (context) {
                                  //       Future.delayed(Duration(seconds: 5), () {
                                  //         Navigator.of(context).pop(true);
                                  //       });
                                  //       return AlertDialog(
                                  //         title: Text('From Date must be small than date to or equal! To Date'),
                                  //       );
                                  //     });
                          ...
                          child: InkWell(
                            onTap: () {
                              if (toDate != null && fromDate != null) {
                                // contextBA.read<AttendanceUserBloc>().add(GetDataAttendanceUserEvent(
